...
type SpecificItemInstance = Artist | Album; // Album added, Song still excluded
type ItemTypeName = 'ARTIST' | 'SONG' | 'ALBUM'; // Keep Song in strings, but no code yet
...
export class RootItemService {
  ...
  constructor(
    ...
    // private songService: SongService, // Still commented out
  ...
  getAllItems(): Observable<SpecificItemInstance[]> {
    ...
    return forkJoin([
      ...
      // this.songService.getAllSongs(), // Still commented out
